"""
Interactive chat / sampling script for LLaDA2.1-MoE models.

Examples
--------
# Chat mode (multi-turn, chat template)
python -u examples/llada21/chat.py --model_name_or_path "YOUR_MODEL_PATH"

# Raw single-turn sampling
python -u examples/llada21/chat.py --model_name_or_path "YOUR_MODEL_PATH" --chat_template False
"""
